...
```bash
uv run python -m langchain_playground.gemini
```
...
```bash
uv run python -m langchain_playground.gemini "What's the weather in San Francisco?"
```

### Get translations:

```bash
uv run python -m langchain_playground.gemini "Translate 'thank you' to Traditional Chinese"
```

### View available tools:

```bash
uv run python -m langchain_playground.gemini "What tools do I have access to?"
```
...
```bash
# Weather query
$ uv run python -m langchain_playground.gemini "What's the weather in Tokyo?"

# Translation
$ uv run python -m langchain_playground.gemini "Say 'good morning' in Traditional Chinese"

# Tool discovery
$ uv run python -m langchain_playground.gemini "List all available tools"
```
